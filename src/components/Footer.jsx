    ...
    >
      <div className="mx-auto flex items-center justify-around sm:flex-row flex-col text-center m-10">
        <div className="flex items-center justify-center flex-col">
          <h2 className="sm:text-4xl text-3xl font-bold capitalize leading-10">
            Deepak Ramani
          </h2>
          <p
            className="my-2 mx-4 sm:max-w-md sm:text-xl"
            style={{ color: "#cacdd2" }}
          >
        ...
        <div className="flex items-center justify-center flex-col mt-6">
          ...
          <div className="flex flex-row gap-4 mt-4">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hover:text-cyan-500 duration-200 ease-in-out cursor-pointer"
            >
              <BsLinkedin size={30} />
            </a>
            <a
      ...
      <div className="flex items-center justify-center">
        <p className="sm:mt-24 sm:text-xl text-sm">
          Copyright &#169; 2024{" "}
          <Link to={"home"} smooth duration={500}>
            <span className="font-semibold hover:text-cyan-500 duration-200 ease-in-out cursor-pointer">
              Deepak Ramani
            </span>
          </Link>
        </p>
