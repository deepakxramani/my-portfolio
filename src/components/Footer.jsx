      ...
      <div className='flex items-center justify-center flex-col'>
        ...
        <div className='flex items-center justify-center flex-col mt-6'>
          ...
          <div className='flex flex-row gap-4 mt-4'>
            <a href='https://www.linkedin.com/in/deepakxramani/' target='_blank' rel='noreferrer' className='hover:text-cyan-500 duration-200 ease-in-out cursor-pointer'><BsLinkedin size={30} /></a>
            <a href='https://github.com/deepakxramani' target='_blank' rel='noreferrer' className='hover:text-cyan-500 duration-200 ease-in-out cursor-pointer'><BsGithub size={30}/></a>
            <a href='https://x.com/deepakxramani' target='_blank' rel='noreferrer' className='hover:text-cyan-500 duration-200 ease-in-out cursor-pointer'><BsTwitterX size={30} /></a>
            <a href='https://www.instagram.com/deepakxramani/' target='_blank' rel='noreferrer' className='hover:text-cyan-500 duration-200 ease-in-out cursor-pointer'><BsInstagram size={30} /></a>
          </div>
      </div>
